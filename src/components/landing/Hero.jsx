            ...
            <Grid container>
              ...
              <Grid item xs={12} md={10}>
                <p className={[classes.p, "container"].join(" ")}>
                  ...
                  to solution. We match our most skilled experts to your
                  problems, using methods designed to ensure an engaging, highly
                  collaborative experience that leads to rapid acceptance,
                  maximum learning, and highly sustainable results.
                </p>
              </Grid>
            </Grid>
          </div>
